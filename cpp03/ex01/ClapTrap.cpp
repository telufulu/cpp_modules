...
ClapTrap::ClapTrap	( void ) : 
	...
	_attackDamage(0)
{
	std::cout << "\033[90mDefault ClapTrap constructor called\033[0m" << std::endl;
	return ;
}
...
ClapTrap::ClapTrap	( const std::string &name ) : 
	...
	_attackDamage(0)
{
	std::cout << "\033[90mClapTrap name constructor called\033[0m" << std::endl;
	return ;
}

ClapTrap::ClapTrap	( const ClapTrap &cpy )
{
	std::cout << "\033[90mClapTrap copy constructor called\033[0m" << std::endl;
	if (this == &cpy)
		return;
...
ClapTrap::~ClapTrap	( void )
{
	std::cout << "\033[90mClapTrap Destructor called\033[0m" << std::endl;
	return ;
}
...
void			ClapTrap::beRepaired ( unsigned int amount )
{
	...
	--this->_energyPoints;
	std::cout << this->_name << " heales " << amount << "HP" << std::endl;
	this->_hitPoints += amount;
	return ;
}
